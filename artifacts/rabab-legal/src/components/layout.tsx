...
import { useOwnerTestMode } from "./owner-test-gate";
...
function LanguagePickerButton() {
  ...
  const currentLanguage =
    PLATFORM_LANGUAGES.find((language) => language.value === lang) ??
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-label={t("اختيار مظهر المنصة", "Choose platform theme")}
        aria-haspopup="listbox"
        aria-expanded={open}
      >
...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div
        className="container mx-auto px-4 h-16 hidden xl:grid items-center"
      ...
      >
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center gap-2 group">
            <div
              className={`relative flex flex-col leading-tight ${lang === "ar" ? "text-right" : "text-left"}`}
            >
          ...
          {isAuthenticated ? (
            <>
              ...
              {isAdmin ? (
                <Link
                  href="/admin"
                  className="text-xs font-medium text-white hover:text-secondary transition-colors whitespace-nowrap"
                >
            ...
            <>
              ...
              <Link
                ...
                className="inline-flex h-9 items-center justify-center whitespace-nowrap rounded-md bg-secondary px-3 text-xs font-bold text-secondary-foreground shadow-sm transition-colors hover:bg-secondary/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
              >
                {isPublicRelease
      ...
      <div className="hidden md:flex xl:hidden container mx-auto h-16 items-center gap-2 px-3">
        <Link href="/" className="flex shrink-0 items-center gap-1.5 group">
          <span
            className="max-w-[118px] truncate text-[11px] font-bold leading-tight whitespace-nowrap"
            style={{ color: "hsl(47 100% 48%)" }}
          >
            {t("رباب محاميتك الرقمية", "Rabab Digital Lawyer")}
          </span>
          <div
            ...
            style={{ background: "hsl(47 100% 48%)" }}
          >
          ...
          {isAuthenticated ? (
            <>
              ...
              <Link
                ...
                className="max-w-[42px] truncate text-[10px] font-medium text-white hover:text-secondary transition-colors whitespace-nowrap"
              >
            ...
            <>
              <Link
                href="/login"
                className="text-[11px] font-medium text-white hover:text-secondary transition-colors whitespace-nowrap"
              >
                {t("تسجيل الدخول", "Login")}
              </Link>
              <Link
                href={isPublicRelease ? "/register" : "/contact"}
                className="inline-flex h-8 items-center justify-center whitespace-nowrap rounded-md bg-secondary px-2 text-[11px] font-bold text-secondary-foreground shadow-sm transition-colors hover:bg-secondary/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                {isPublicRelease
                  ? t("حساب جديد", "Register")
                  : t("تواصل", "Contact")}
      ...
      <div className="md:hidden container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex min-w-0 items-center gap-2 group">
          <span
            className="min-w-0 max-w-[calc(100vw-116px)] truncate font-bold text-sm whitespace-nowrap"
            style={{ color: "hsl(47 100% 48%)" }}
          >
            {t("رباب محاميتك الرقمية", "Rabab Digital Lawyer")}
          </span>
              ...
              {PLATFORM_LANGUAGES.map((language) => {
                ...
                return (
                  ...
                  >
                    {lang === "ar" ? language.labelAr : language.labelEn}
                    {active && (
                      <Check className="inline-block ms-1.5 h-3 w-3" />
                    )}
                  </button>
                );
              })}
          ...
          {isAuthenticated ? (
            ...
            <div className="flex flex-col gap-2 mt-4">
              <Link
                href="/login"
                onClick={() => setIsMobileMenuOpen(false)}
                className="inline-flex h-10 w-full items-center justify-center rounded-md border-2 border-secondary/65 bg-background px-4 py-2 text-sm font-medium text-foreground shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                {t("تسجيل الدخول", "Login")}
              </Link>
              <Link
                href={isPublicRelease ? "/register" : "/contact"}
                onClick={() => setIsMobileMenuOpen(false)}
                className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-bold text-primary-foreground shadow-sm transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                {isPublicRelease
                  ? t("حساب جديد", "Register")
                  : t("تواصل معنا", "Contact us")}
...
export function Footer() {
  ...
  return (
    <footer
      dir={lang === "ar" ? "rtl" : "ltr"}
      className="bg-primary text-primary-foreground py-12 mt-auto border-t-[4px] border-secondary"
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="flex flex-col leading-tight">
                <span
                  ...
                  style={{ color: "hsl(47 100% 48%)" }}
                >
                  {t("رباب محاميتك الرقمية", "Rabab, your digital lawyer")}
                </span>
                <span
            ...
            <p className="text-white leading-relaxed max-w-2xl">
              {lang === "ar" ? (
                <>
                  منصة رقمية متطورة تقدم استشارات قانونية دقيقة وموثقة للأفراد
                  والشركات{" "}
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  ...
                  className="text-white hover:text-secondary transition-colors"
                >
                  {t("الخدمات القانونية", "Legal Services")}
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="text-white hover:text-secondary transition-colors"
                >
                  {t("صياغة العقود", "Contract Drafting")}
                </Link>
              </li>
              <li>
                <Link
        ...
        <div
          className="mt-12 pt-8 border-t border-primary-foreground/20 text-center text-sm flex flex-col md:flex-row justify-between items-center gap-4"
          style={{ color: "hsl(47 100% 48%)" }}
        >
          <p>
            © {new Date().getFullYear()}{" "}
            {t("رباب محاميتك الرقمية", "Rabab, your digital lawyer")} — RABAB
            LEGAL AI. {t("جميع الحقوق محفوظة.", "All rights reserved.")}
          </p>
...
export function AdminSidebar({ children }: { children: React.ReactNode }) {
  ...
  const menu = [
    ...
    {
      name: t("قاعدة المعرفة", "Knowledge Base"),
      icon: BookOpen,
      path: "/admin/knowledge-base",
    },
    {
      name: t("جودة البيانات", "Data Quality"),
      icon: ShieldCheck,
      path: "/admin/knowledge-quality",
    },
    {
      name: t("حالة المصادر", "Source Status"),
      icon: ShieldCheck,
      path: "/admin/source-status",
    },
    {
      name: t("تحكم الأقسام", "Section Control"),
      icon: Settings,
      path: "/admin/section-control",
    },
    {
      name: t("تقرير التحويل", "Conversion Report"),
      icon: TrendingUp,
      path: "/admin/conversion-report",
    },
    // [DISABLED Aug-2026] بوت تلجرام معطَّل — أُزيل من القائمة حتى لا يظهر كخيار غير عامل
    {
      name: t("أحكام وتعاميم العدل", "MOJ Rulings & Circulars"),
      icon: BookOpen,
      path: "/admin/moj-content",
    },
    {
      name: t("المدونات القضائية", "Judicial Codex"),
      icon: BookOpen,
      path: "/admin/legal-codex",
    },
    {
      name: t("إعدادات البريد", "Email Settings"),
      icon: Mail,
      path: "/admin/email-settings",
    },
    {
      name: t("رسائل التواصل", "Contact Messages"),
      icon: Inbox,
      path: "/admin/contact-messages",
    },
    {
      name: t("الإشعارات القانونية", "Legal Notifications"),
      icon: Bell,
    ...
    {
      name: t("المدفوعات", "Payments"),
      icon: CreditCard,
      path: "/admin/payments",
    },
    {
      name: t("الاستشارات", "Consultations"),
      icon: MessageSquare,
      path: "/admin/consultations",
    },
    {
      name: t("سجل التدقيق", "Audit Log"),
      icon: ClipboardList,
      path: "/admin/audit-log",
    },
    {
      name: t("إعدادات واتساب", "WhatsApp Settings"),
      icon: MessageSquare,
      path: "/admin/whatsapp",
    },
  ];
  ...
  return (
    <div
      dir={lang === "ar" ? "rtl" : "ltr"}
      className="min-h-[100dvh] flex flex-col md:flex-row bg-muted/30"
    >
      <aside className="w-full md:w-64 bg-card border-l-2 border-secondary/60 shadow-sm shadow-secondary/10 shrink-0 flex flex-col">
        <div className="p-6 border-b border-secondary/35">
          <h2 className="font-bold text-xl text-card-foreground">
            {t("الإدارة المركزية", "Central Administration")}
          </h2>
        </div>
