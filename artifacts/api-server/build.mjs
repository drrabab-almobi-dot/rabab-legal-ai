...
async function buildAll() {
  ...
  await esbuild({
    ...
    // Express is intentionally externalized so the generated Vercel entrypoint keeps
    // an explicit `import express` that Vercel's Express framework detector can see.
    external: [
      "express",
      "*.node",
      "sharp",
